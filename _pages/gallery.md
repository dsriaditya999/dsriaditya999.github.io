...
<style>
  ...
  .swiper-slide {
    ...
    width: auto; /* Ensure slide width adjusts to content */
  }

  .custom-slide {
    position: relative;
    width: 50%; /* Width of the slide content */
    display: flex;
...
<script>
  // Function to add hover pause effect to swiper containers
  function addHoverPause(swiperId) {
